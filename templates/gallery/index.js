...
import { listModuleDependencies, registerModuleEntryManifest } from './js/modules/moduleEntries.js';

registerModuleEntryManifest();

const MODULE_DEPENDENCIES = listModuleDependencies({ includeLegacyCompat: true });
