...
export function updateStatusElement(element, message, options = {}) {
    if (!element) {
        return;
    }
...
export function applyInlineStyles(element, styles) {
...
export function ensureElement(current, options = {}) {
